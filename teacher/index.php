...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg, #ead466ff 0%, #764ba2 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .login-header {
            background: linear-gradient(135deg, #78daf6ff 0%, #ad7bdeff 100%);
            padding: 40px 20px;
            text-align: center;
            color: white;
        }
                ...
                <div class="login-card">
                    <div class="login-header">
                        <!-- <i class="bi bi-gear-fill" style="font-size: 3rem;"></i> -->
                         <img src="<?=$_ENV['PAGE_ICON']?>" height="50px" width="50px">
                         
                        <h2 class="mt-3 mb-2">ALS Teacher Portal</h2>
                        <p class="mb-0">Alternative Learning System</p>
                    </div>
                    <div class="login-body">
                        <p class="text-center text-muted mb-4">
                             Login or Register using your GMail account.
                        </p>
